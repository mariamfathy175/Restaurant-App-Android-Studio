...
public class SushiRestaurant extends AppCompatActivity {
    private static final String TAG = BurgerRestaurant.class.getSimpleName();
    private RecyclerView recyclerView;
    private List<item> cartList;
    private CartListAdapter mAdapter;

    private static final String URL = "https://api.jsonserve.com/p4KU1y";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sushi_restaurant);
