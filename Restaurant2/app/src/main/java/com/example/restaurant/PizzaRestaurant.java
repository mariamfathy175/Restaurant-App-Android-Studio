...
public class PizzaRestaurant extends AppCompatActivity {
    ...
    private static final String URL = "https://api.jsonserve.com/RG60cR";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pizza_restaurant);
